        ...
        {!isPast(startDate) ? (
          <>
            <Link
              ...
              className="group text-primary-300 border-primary-800 hover:bg-accent-600 hover:text-primary-900 flex flex-grow cursor-pointer items-center gap-2 border-b px-3 text-xs font-bold uppercase transition-colors"
            >
